...
void dynamiccallback(terrain_analysis::TerrainAnalysisConfig &config, uint32_t level){
    scanVoxelSize = config.scanVoxelSize;
...
int main(int argc, char **argv) {
  ...
  dynamic_reconfigure::Server<terrain_analysis::TerrainAnalysisConfig>::CallbackType f;
